              ...
              <Col sm={6} md={8}>
                ...
                <Tabs defaultActiveKey="profile" id="uncontrolled-tab-example" className="aboutab">
                  <Tab eventKey="home" title="Experience">
                    <br />
                    <p className='aboutp'>Java 1 year<br /><br />HTML+CSS 1 year<br /><br />JavaScript 3 month<br /><br />SpringBoot 3 month<br /><br />React 3 month<br /><br />SQL 8 month</p>
                  </Tab>
                  <Tab eventKey="profile" title="Certifications">
                    <br />
                    <p className='aboutp'>JAVA Silver <br /><br />Fundamental Information Technology Engineer<br /><br />TOEIC 880<br /><br />JLPT N1</p>
                  </Tab>
                </Tabs>
              </Col>
              <Col sm={6} md={4}>
