                    ...
                    <div className='skill-bx'>
                      ...
                      <Row>
                        <Col className='skillxy' id='xy1' style={{ display: 'flex', flexDirection: 'row-reverse' }}>
                          ...
                          ><img src={springboot} alt=''/></motion.div>
                          <motion.div
                                initial={{ x: '630%', y: '260%' }}
                                whileInView={{x:200, y:100}}                                
                                transition={{ duration: 0.7, delay: 0.2 }}
                                style={{ width: 50, height: 50, margin: "0" }}
                          ><img src={mybatis} alt=''/></motion.div>
                        </Col>
                        <Col className='skillxy' id='xy2'>
                          ...
                          <motion.div
                                ...
                                transition={{ duration: 0.7, delay: 0.2 }}
                                style={{ width: 50, height: 50, margin: "0" }}
                                ><img src={java} alt=''/></motion.div>
                          <motion.div
                                initial={{ x: '-70%', y: '150%' }}
                                whileInView={{x:150, y:-0}}                                
                                transition={{ duration: 0.7, delay: 0.2 }}
                                style={{ width: 50, height: 50, margin: "0" }}
                                ><img src={mysql} alt=''/></motion.div>
                        </Col>
                      </Row>
                      <Row>
                      <Col className='skillxy' id='xy3' style={{ display: 'flex', flexDirection: 'row-reverse' }}>
                          ...
                          <motion.div
                                ...
                                transition={{ duration: 0.7, delay: 0.2 }}
                                style={{ width: 50, height: 50, margin: "0" }}
                                ><img src={github} alt=''/></motion.div>
                           <motion.div
                                initial={{ x: '400%', y: '-100%' }}
                                whileInView={{x:-100, y:0}}                                
                                transition={{ duration: 0.7, delay: 0.2 }}
                                style={{ width: 50, height: 50, margin: "0" }}
                                ><img src={azure} alt=''/></motion.div>
                        </Col> 
                        <Col className='skillxy' id='xy4'>
                          ...
                          <motion.div
                                ...
                                transition={{ duration: 0.7, delay: 0.2 }}
                                style={{ width: 50, height: 50, margin: "0" }}
                                ><img src={react} alt=''/></motion.div>
                          <motion.div
                                initial={{ x: '-70%', y: '-300%' }}
                                whileInView={{x:200, y:-50}}                                
                                transition={{ duration: 0.7, delay: 0.2 }}
                                style={{ width: 50, height: 50, margin: "0 10px" }}
                                ><img src={javascript} alt=''/></motion.div>
                          <motion.div
                                initial={{ x: '-70%', y: '-400%' }}
                                whileInView={{x:20, y:-100}}                                
                                transition={{ duration: 0.7, delay: 0.2 }}
                                style={{ width: 50, height: 50, margin: "0 10px" }}
                                ><img src={bootstrap} alt=''/></motion.div>
                        </Col>
                      </Row>
                    </div>
                </Col>
